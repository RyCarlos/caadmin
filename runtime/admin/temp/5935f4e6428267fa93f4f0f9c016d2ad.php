<?php /*a:2:{s:66:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\auth_rule\create.html";i:1601362402;s:61:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\common\base.html";i:1601191666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            是否菜单<span class="req-color">*</span>
                        </label>

                        <div class="layui-input-inline">
                            <input required lay-verify="required" checked type="radio" <?php if(isset($data['is_menu']) && $data['is_menu'] == 1): ?>checked<?php endif; ?> name="is_menu" class="layui-input" value="1" title="是">
                            <input required lay-verify="required" type="radio" <?php if(isset($data['is_menu']) && $data['is_menu'] == 0): ?>checked<?php endif; ?> name="is_menu" class="layui-input" value="0" title="否">
                        </div>
                    </div>
