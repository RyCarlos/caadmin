<?php /*a:2:{s:65:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\auth_rule\index.html";i:1601436728;s:61:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\common\base.html";i:1601191666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <table class="layui-hide" id="DATA-PAGE-TABLE" lay-filter="DATA-PAGE-TABLE-FILTER"
                       ...
                       data-operate-del="<?php echo $auth->check((string)url('delete')); ?>">
                </table>
            </div>
        </div>
    </div>
