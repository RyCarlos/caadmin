<?php /*a:2:{s:60:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\role\index.html";i:1600754729;s:61:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\common\base.html";i:1600932612;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-row">
    <div class="layui-fluid">
        <div class="layui-card">
            ...
            <!--数据列表-->
            <div class="layui-card-body">
                <table class="layui-hide" id="DATA-PAGE-TABLE"  data-url="<?php echo url('index'); ?>" lay-filter="DATA-PAGE-TABLE-FILTER"></table>
            </div>
        </div>
    </div>
</div>
