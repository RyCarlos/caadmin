<?php /*a:2:{s:60:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\icon\index.html";i:1599818353;s:61:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\common\base.html";i:1601191666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    $(function () {
        $('li').on('click', function () {
            ...
            if (className) {
                parent.$('[name="<?php echo htmlentities($field); ?>"]').val(className).trigger('change');
