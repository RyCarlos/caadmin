<?php /*a:1:{s:60:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\user\login.html";i:1600067873;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="bg pos-rel">
    <div class="login-form layui-form">
        ...
        <div class="layui-form-item">
            <button class="layui-btn layui-btn-fluid bg-333" data-url="<?php echo url('admin/user/login'); ?>" data-href="<?php echo url('admin/index/index'); ?>" data-method="post" lay-submit lay-filter="admin-ajax-form-btn">登录</button>
        </div>
    </div>
</div>
