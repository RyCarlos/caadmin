<?php /*a:2:{s:65:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\auth_group\edit.html";i:1601362563;s:61:"D:\phpstudy_pro\WWW\mybackend\app\admin\view\common\base.html";i:1601191666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-input-block">
                            <select name="pid" lay-search>
                                ...
                                <?php if(isset($list)): foreach($list as $lkey => $lval): ?>
                                    <option <?php if($data['id'] == $lval['id']): ?>disabled<?php endif; if(isset($data['pid']) && $data['pid'] == $lval['id']): ?>selected<?php endif; ?> value="<?php echo htmlentities($lval['id']); ?>"><?php echo $lval['position']; ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
